...
def _verify_using_custom_ca_certs(
    ...
    try:
        ...
        for cert_bytes in custom_ca_certs:
            CertAddEncodedCertificateToStore(
                hRootCeó
    PˆVi(  ã                   óÌ  • S r SSKr\R                  S:  a  \" S5      e\R                  S:  a  \R
                  R                  S;  ae   SSKr\R                  " 5       r
\R                  " 5       R                  \
\
5      r \" \S5      (       d  \R                  r\" \S5      (       d  M  CCC
S
SKJrJrJr  CC/ SQrSrg! \ a
    \" S5      Sef = f! \ a	    \" S	5      ef = f)z4Verify certificates using native system trust storesé    N)é   é
   z(truststore requires Python 3.10 or later)r   é   )ÚcpythonÚpypyÚget_unverified_chainz?truststore requires peer certificate chain APIs to be availablez$truststore requires the 'ssl' moduleé   )Ú
SSLContextÚextract_from_sslÚinject_into_ssl)r
   r   r   z0.10.1)Ú__doc__ÚsysÚ_sysÚversion_infoÚImportErrorÚimplementationÚnameÚsslÚ_sslÚ	MemoryBIOÚ_sslmemÚcreate_default_contextÚwrap_bioÚ_sslobjÚhasattrÚAttributeErrorÚ_apir
   r   r   Ú__all__Ú__version__© ó    Úa/home/nureh/belajar-js/myjava/env/lib/python3.13/site-packages/pip/_vendor/truststore/__init__.pyÚ<module>r#      s
  ğÙ :ã à×ÑwÓÙ
Ğ@Ó
AĞAğ ×ÑwÓ 4×#6Ñ#6×#;Ñ#;ĞCVÓ#Vğ#Ûğ —.’.Ó"ˆØ×-Ò-Ó/×8Ñ8ØØó
ˆğ	Ù˜gĞ'=×>Ñ>Ø!Ÿ/™/ñ ˜gĞ'=×>Ó>ğ '˜7ç ?Ñ ?àˆ$â
?€Øøğ ó 	ÙØQóàğğ	ûğ ó BÙĞ@ÓAĞAğBús   Á
C Â(C ÃCÃC#                                               ÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿ